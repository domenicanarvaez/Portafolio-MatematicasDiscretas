...
<table>
  ...
  <tr>
    ...
    <td>Mario Enrique Cueva Hurtado </td>
  </tr>
  <tr>
...
* [📚 Contenidos del Portafolio](https://github.com/domenicanarvaez/Teoria-de-la-programacion-Portafolio-Digital/blob/main/PortafolioDigital.md#-contenidos-del-portafolio)
    * [📌 Unidad 1: Lógica Matemática](Unidad1.md)
      ...
      * [📝 Descripción de Actividades](https://github.com/domenicanarvaez/Portafolio-MatematicasDiscretas/blob/main/Unidad1.md#-descripci%C3%B3n-de-actividades-)
          ...
          * [🧪 Actividades de Aprendizaje Práctico Experimental (APE)](https://github.com/domenicanarvaez/Portafolio-MatematicasDiscretas/blob/main/Unidad1.md#-actividades-de-aprendizaje-pr%C3%A1ctico-experimental-ape-)
          * [🧠 Actividades de Aprendizaje Autónomo (AA)](https://github.com/domenicanarvaez/Portafolio-MatematicasDiscretas/blob/main/Unidad1.md#-actividades-de-aprendizaje-aut%C3%B3nomo-aa-)
...
¡El punto de partida! Contiene el desarrollo de habilidades de razonamiento lógico para solucionar problemas ligados a la computación.
